...
namespace RX
{
    public static class ConfigOperation
    {
        ...
        public static void UpdateConnectionStringsConfig(this string newName, string newConString, string newProviderName)
        {
            //指定config文件读取
            string file = System.Windows.Forms.Application.ExecutablePath;
        ...
        public static void UpdateAppConfig(this string newKey, string newValue)
        {
            string file = System.Windows.Forms.Application.ExecutablePath;
            Configuration config = ConfigurationManager.OpenExeConfiguration(file);
            bool exist = false;
        ...
        public static void UpdateServiceModelConfig(this string configPath, string serverIP)
        {
        ...
        public static void UpdateConfig(this string configPath, string serverIP)
        {
            Configuration config = ConfigurationManager.OpenExeConfiguration(configPath);
